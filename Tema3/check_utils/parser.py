...
def get_task(id=None, points=None, tests_no=None, points_distribution=None, timeout=None, timeout_valgrind=None, memory=None, use_stdin=None, use_stdout=None, use_valgrind=None, use_env_deps=None, tests_valgrind=[]):
    ...
    config = {
        ...
        'tests': tests,
        'timeout': timeout,
        'timeout_valgrind': timeout_valgrind,
        'memory': memory,
        'use_stdin': use_stdin,
...
def get_config(path='./tasks/config.json'):
    ...
    for t in config.tasks:
        ...
        timeout_valgrind = t['timeout_valgrind'] if 'timeout_valgrind' in t else 500
